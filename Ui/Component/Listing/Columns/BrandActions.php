...
use Wise\Fancy\Block\Adminhtml\Brand\Grid\Renderer\Action\UrlBuilder;
use Magento\Framework\UrlInterface;

class BrandActions extends Column
{
	/** Url Path */
	const BRAND_URL_PATH_EDIT = 'wisefancy/brand/edit';
	const BRAND_URL_PATH_DELETE = 'wisefancy/brand/delete';
