...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Wise_Fancy::brand_edit');
    }
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Edit Brand') : __('New Block Fancy Box Designer'),
            $id ? __('Edit Brand') : __('New Block Fancy Box Designer')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Box'));
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getname() : __('New Block Fancy Box Designer'));
